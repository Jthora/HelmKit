...
def make():
    ...
    L.cut(arch, L.add_teardrop("cross", (C.CX, C.HUB_SOCKET[1], C.CROWN_CROSS_Z), C.M3_CLEAR_DIA / 2, fy + 4.0, (0.0, 1.0, 0.0), (-1.0, 0.0, 0.0), verts=24))   # arch prints on edge: -X is up
    return arch
