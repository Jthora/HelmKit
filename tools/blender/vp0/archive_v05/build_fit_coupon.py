...
def make():
    ...
    L.union(plate, L.face_ratchet_ring("ratchet", (28.0, 4.0, 6.0), (0, 0, 1), C.NAPE_RATCHET_R[0], C.NAPE_RATCHET_R[1],
                                       C.NAPE_RATCHET_TEETH, C.NAPE_RATCHET_H, direction=C.NAPE_RATCHET_DIR))
    disc = L.revolve("disc", [(2.75, 0.0), (20.0, 0.0), (20.0, 4.0), (2.75, 4.0)], axis="Z", center=(85.0, 0.0, 0.0), segments=96)
