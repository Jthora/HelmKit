...
def make_retainer():
    """Printed retainer threaded onto the M5 axle tip: washer and nut in 2 mm. Screw it down to set the spring preload."""
    ...
    L.cut(r, cyl("thread", (0.0, 0.0, w0 + rt / 2), rh / 2, rt + 2.0, verts=24))
    return r
...
PARTS = {
    ...
    "nape_retainer": (make_retainer, L.rot_dir_to(N_OUT, (0, 0, 1)), ["print flat; thread onto the M5 tip against the spring, epoxy-lock at the chosen preload"]),
