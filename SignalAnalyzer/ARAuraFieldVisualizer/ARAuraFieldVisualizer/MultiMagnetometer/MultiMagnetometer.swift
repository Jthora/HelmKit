...
struct MagnetometerMagnitudeReading {
...
protocol MultiMagnetometerMagnitudeDelegate {
...
class MultiMagnetometer: NSObject {
    ...
    var magnitudeDelegate:MultiMagnetometerMagnitudeDelegate?
    ...
    private func updateMagnetometer(_ data:CMMagnetometerData?) -> Void {
        ...
        if let location = GPS.shared.location {
            magnitudeDelegate?.updateMagnetometer(magnitude: magnitude, location: location)
        }
    }
}
