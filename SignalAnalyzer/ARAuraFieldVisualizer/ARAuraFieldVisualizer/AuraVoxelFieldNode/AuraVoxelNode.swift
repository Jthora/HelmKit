...
class AuraVoxelNode:SCNNode {
    ...
    init(connection:CGFloat = 0, microTesla:CGFloat = 0, direction:SCNVector3 = SCNVector3(0,0,0), subScale:CGFloat, gameMode:Bool = true) {
        ...
        particleSystem.particleColor = UIColor.tmoHotPink//UIColor.init(red: 0.5, green: 1.0, blue: 0.5, alpha: 1)
        particleSystem.particleColorVariation = SCNVector4(0.2,0.25,0,0.5)
